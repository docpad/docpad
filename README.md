...
Initially web development was pretty easy, you just wrote a bunch of files and you have a website. These days, it's a lot more complicated than that. Things like databases, synchronisation, legacy frameworks and languages all slow the entire process down into a painful crawl. It doesn't have to be like that though.
