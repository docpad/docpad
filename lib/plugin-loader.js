...
(function() {
  var PluginLoader, balUtil, fs, path, semver, _,
  ...
  PluginLoader = (function() {
    ...
    PluginLoader.prototype.exists = function(next) {
      ...
      path.exists(packagePath, function(exists) {
        if (!exists) {
          ...
          return balUtil.openFile(function() {
            return fs.readFile(packagePath, function(err, data) {
              balUtil.closeFile();
              if (err) {
    ...
    PluginLoader.prototype.supported = function(next) {
      var engines, keywords, platforms, supported, _ref;
      supported = true;
      if (this.packageData) {
