...
(function() {
  var Base, CSON, DocPad, EventSystem, airbrake, balUtil, caterpillar, pathUtil, queryEngine, _,
    ...
    */
    ...
    function DocPad(config, next) {
      ...
      this.loadConfiguration(config, {}, function(err) {
        ...
        _this.blocks.meta = new _this.MetaCollection();
    ...
    DocPad.prototype.loadConfiguration = function(instanceConfig, options, next) {
      ...
      startLoading = function() {
        return docpad.start('loading', function(lockError) {
          ...
          websiteConfig = {};
          tasks = new balUtil.Group(function(err) {
            var config, key, postTasks, type, typePath, typePaths, _i, _j, _len, _len1, _ref;
            if (err) {
              return fatal(err);
            }
            ...
            _ref = ['documents', 'files', 'layouts', 'plugins'];
    ...
    DocPad.prototype.getTemplateData = function(userData) {
      ...
      templateData = _.extend({
        ...
        getDatabase: function() {
          ...
          return docpad.database;
        },
        getCollection: function(name) {
          this.documentModel.set({
            referencesOthers: true
          });
          return docpad.collections[name];
        },
        getBlock: function(name) {
          var block, classname, clone;
          block = docpad.blocks[name];
          classname = name[0].toUpperCase() + name.slice(1) + 'Collection';
          return clone = new docpad[classname](block.models);
        }
