...
(function() {
  var Backbone, CSON, DocumentModel, FileModel, balUtil, mime, pathUtil, yaml, _,
    ...
    DocumentModel.prototype.contextualize = function(next) {
      ...
      DocumentModel.__super__.contextualize.call(this, function() {
        return _this.getEve(function(err, eve) {
          var basename, contentTypeRendered, extensionRendered, filenameRendered, fullPath, name, outPath, relativeBase, url;
          if (err) {
            return typeof next === "function" ? next(err) : void 0;
          }
          fullPath = _this.get('fullPath');
          ...
          url = _this.meta.get('url') || null;
          name = _this.meta.get('name') || null;
          outPath = _this.meta.get('outPath') || null;
          if (eve) {
